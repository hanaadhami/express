...
function volume(volumeOptions) {
    var instanceOptions = tslib_1.__assign({}, DEFAULT_FS_NO_EPERM_ANYMORE_OPTIONS, (volumeOptions ? volumeOptions.fsNoEpermAnymore : {}));
    var impl = fs_no_eperm_anymore_1.instantiate(instanceOptions);
    return {
        _impl: tslib_1.__assign({}, fs_1.default, impl),
        _name: exports.NAME,
        chmod: impl.chmod,
        chown: impl.chown,
        close: impl.close,
